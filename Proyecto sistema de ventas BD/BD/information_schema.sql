...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-09-2025 a las 19:51:41
...
--
-- Estructura Stand-in para la vista `ALL_PLUGINS`
...
--
-- Estructura Stand-in para la vista `CLIENT_STATISTICS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `GEOMETRY_COLUMNS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `GLOBAL_STATUS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `GLOBAL_VARIABLES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INDEX_STATISTICS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_LOCKS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_LOCK_WAITS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_MUTEXES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_COLUMNS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_DATAFILES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_FIELDS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_FOREIGN`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_FOREIGN_COLS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_INDEXES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_SEMAPHORE_WAITS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_TABLES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_TABLESPACES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_TABLESTATS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_SYS_VIRTUAL`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_TABLESPACES_ENCRYPTION`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `INNODB_TABLESPACES_SCRUBBING`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `KEY_CACHES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `SESSION_STATUS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `SESSION_VARIABLES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `SPATIAL_REF_SYS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `SQL_FUNCTIONS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `SYSTEM_VARIABLES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `TABLE_STATISTICS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `user_variables`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura para la vista `CLIENT_STATISTICS`
--
...
--
-- Estructura para la vista `GEOMETRY_COLUMNS`
--
...
--
-- Estructura para la vista `GLOBAL_STATUS`
--
...
--
-- Estructura para la vista `GLOBAL_VARIABLES`
--
...
--
-- Estructura para la vista `INDEX_STATISTICS`
--
...
--
-- Estructura para la vista `INNODB_LOCKS`
--
...
--
-- Estructura para la vista `INNODB_LOCK_WAITS`
--
...
--
-- Estructura para la vista `INNODB_MUTEXES`
--
...
--
-- Estructura para la vista `INNODB_SYS_COLUMNS`
--
...
--
-- Estructura para la vista `INNODB_SYS_DATAFILES`
--
...
--
-- Estructura para la vista `INNODB_SYS_FIELDS`
--
...
--
-- Estructura para la vista `INNODB_SYS_FOREIGN`
--
...
--
-- Estructura para la vista `INNODB_SYS_FOREIGN_COLS`
--
...
--
-- Estructura para la vista `INNODB_SYS_INDEXES`
--
...
--
-- Estructura para la vista `INNODB_SYS_SEMAPHORE_WAITS`
--
...
--
-- Estructura para la vista `INNODB_SYS_TABLES`
--
...
--
-- Estructura para la vista `INNODB_SYS_TABLESPACES`
--
...
--
-- Estructura para la vista `INNODB_SYS_TABLESTATS`
--
...
--
-- Estructura para la vista `INNODB_SYS_VIRTUAL`
--
...
--
-- Estructura para la vista `INNODB_TABLESPACES_ENCRYPTION`
--
...
--
-- Estructura para la vista `INNODB_TABLESPACES_SCRUBBING`
--
...
--
-- Estructura para la vista `KEY_CACHES`
--
...
--
-- Estructura para la vista `SESSION_STATUS`
--
...
--
-- Estructura para la vista `SESSION_VARIABLES`
--
...
--
-- Estructura para la vista `SPATIAL_REF_SYS`
--
...
--
-- Estructura para la vista `SQL_FUNCTIONS`
--
...
--
-- Estructura para la vista `SYSTEM_VARIABLES`
--
...
--
-- Estructura para la vista `TABLE_STATISTICS`
--
...
--
-- Estructura para la vista `user_variables`
--
