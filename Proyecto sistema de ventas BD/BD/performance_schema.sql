...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-09-2025 a las 19:51:31
...
--
-- Estructura de tabla para la tabla `events_stages_current`
--
...
--
-- Estructura de tabla para la tabla `events_stages_history`
--
...
--
-- Estructura de tabla para la tabla `events_stages_history_long`
--
...
--
-- Estructura de tabla para la tabla `events_stages_summary_by_account_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_stages_summary_by_host_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_stages_summary_by_thread_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_stages_summary_by_user_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_stages_summary_global_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_statements_current`
--
...
--
-- Estructura de tabla para la tabla `events_statements_history`
--
...
--
-- Estructura de tabla para la tabla `events_statements_history_long`
--
...
--
-- Estructura de tabla para la tabla `events_statements_summary_by_account_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_statements_summary_by_digest`
--
...
--
-- Estructura de tabla para la tabla `events_statements_summary_by_host_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_statements_summary_by_thread_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_statements_summary_by_user_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_statements_summary_global_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_waits_summary_by_account_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_waits_summary_by_host_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_waits_summary_by_user_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `host_cache`
--
...
--
-- Estructura de tabla para la tabla `objects_summary_global_by_type`
--
...
--
-- Estructura de tabla para la tabla `session_account_connect_attrs`
--
...
--
-- Estructura de tabla para la tabla `session_connect_attrs`
--
...
--
-- Estructura de tabla para la tabla `setup_actors`
--
...
--
-- Estructura de tabla para la tabla `setup_objects`
--
...
--
-- Estructura de tabla para la tabla `socket_instances`
--
...
--
-- Estructura de tabla para la tabla `socket_summary_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `socket_summary_by_instance`
--
...
--
-- Estructura de tabla para la tabla `table_io_waits_summary_by_index_usage`
--
...
--
-- Estructura de tabla para la tabla `table_io_waits_summary_by_table`
--
...
--
-- Estructura de tabla para la tabla `table_lock_waits_summary_by_table`
--
